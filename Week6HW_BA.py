...
class MyGUI:
    def __init__(self):
        ...
        #entries 
        self.amount2 = tkinter.Entry(self.second_f,width = 15, foreground='cyan')
        self.amount3 = tkinter.Entry(self.third_f,width = 15, foreground = 'cyan')
        self.amount4 = tkinter.Entry(self.fourth_f,width = 15, foreground = 'cyan')
